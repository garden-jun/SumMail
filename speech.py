...
GOOGLE_API_KEY= "AIzaSyBkZKcmTvkSFSSPJdf2i9VXvnKSdI4Xhow"
...
def generate_content(mail):
    ...
    response_summary = model.generate_content(f'Please summarise in {length} words this document: '+ contents)
